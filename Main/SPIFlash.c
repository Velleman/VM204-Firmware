...
#define SPI_ON_BIT          (SPIFLASH_SPICON2bits.ON)
#else
...
void SPIFlashInit(void) {
    ...
    // Configure SPI
    SPI_ON_BIT = 0;
    SPIFLASH_SPICON1 = PROPER_SPICON2;
    SPI_ON_BIT = 1;
    ...
    SPI2ABRG = (GetPeripheralClock() - 1ul) / 2ul / SPIFLASH_MAX_SPI_FREQ;
